...
#define TRANSMISON_SPEED "100Mbps"

using namespace ns3;

NS_LOG_COMPONENT_DEFINE ("Tsn-exemple-3");
...
main (int argc, char *argv[])
{
  ...
  pointToPoint.EnablePcapAll("Tsn-exemple-3");
  ...
  std::cout << "Tsn-exemple-3 pointToPoint" << std::endl;
  std::cout << 2 << " Nodes " << std::endl;
  std::cout << "Total simulated Time: "<< simulationDuration.GetSeconds() << std::endl;
